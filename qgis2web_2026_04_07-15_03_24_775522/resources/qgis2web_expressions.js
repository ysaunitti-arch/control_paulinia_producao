...
function exp_Loteamentos_2rule0_eval_expression(context) {
    ...
    if (feature.properties) {
        return (feature.get('loteamentos_analise_revisao_cadastral')  == 'PENDENTE');
    } else {
        return (feature.get('loteamentos_analise_revisao_cadastral')  == 'PENDENTE');
    }
}
...
function exp_Loteamentos_2rule1_eval_expression(context) {
    ...
    if (feature.properties) {
        return (feature.get('loteamentos_analise_ortofoto_base_CAD')  == 'OK');
    } else {
        return (feature.get('loteamentos_analise_ortofoto_base_CAD')  == 'OK');
    }
}
...
function exp_Loteamentos_2rule3_eval_expression(context) {
